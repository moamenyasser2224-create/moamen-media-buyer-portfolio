// =====================================================================
// TIGER ELITE — SITE DATA (v2 — ELITE UPGRADE)
// عدّل بياناتك من هنا فقط. لا داعي لمس أي كومبوننت.
// أي حقل مكتوب [ADD YOUR DATA] أو [ADD VERIFIED DATA] يجب استبداله ببياناتك الحقيقية.
// =====================================================================
...
export const profile = {
  ...
  whatsapp: "201098546416",
  email: "[ADD YOUR DATA — البريد الإلكتروني]",
  linkedin: "https://www.linkedin.com/in/moamen-yasser-29b066276",
  facebook: "[ADD YOUR DATA — رابط صفحة Facebook]",
  instagram: "[ADD YOUR DATA — رابط Instagram]",
  cvUrl: "[ADD YOUR DATA — رابط تحميل السيرة الذاتية PDF]",
  yearsExperience: "[ADD YOUR DATA]",
  photo: "[ADD YOUR PHOTO — ضع صورتك في /public/profile.jpg وحدّث هذا المسار]",
};
...
export const heroMetrics = [
  ...
  },
  {
    ...
    context: "نفس المتجر، بعد خصم التكاليف والإعلانات",
  },
  {
    value: "4.85",
    unit: "EGP",
    label: "Cost per Conversion",
    context: "متوسط عبر 10 حملات TikTok Ads نشطة",
  },
];
...
export const keyMetrics = [
  {
    ...
    value: "785.57K",
    unit: "EGP",
    source: "لوحة تحكم Easy Orders",
    period: "[ADD VERIFIED CONTEXT — الفترة الزمنية الدقيقة]",
    platform: "Meta Ads",
  },
  {
    ...
    value: "685.49K",
    unit: "EGP",
    source: "لوحة تحكم Easy Orders (بعد خصم التكاليف)",
    period: "[ADD VERIFIED CONTEXT]",
    platform: "Meta Ads",
  },
  {
    label: "زيارات تم توليدها",
    value: "36.99K",
    unit: "زيارة",
    source: "لوحة تحكم Easy Orders",
    period: "[ADD VERIFIED CONTEXT]",
  ...
  {
    label: "طلبات تم إغلاقها",
    value: "3.39K",
    unit: "طلب",
    source: "لوحة تحكم Easy Orders — بمعدل تحويل 9.17%",
    period: "[ADD VERIFIED CONTEXT]",
    platform: "Meta Ads",
  },
  {
    label: "تكلفة التحويل (TikTok Ads)",
    value: "4.85",
    unit: "EGP",
    source: "TikTok Ads Manager — متوسط 10 حملات",
    period: "2025-12-10 → 2026-02-24",
    platform: "TikTok Ads",
  },
  {
    label: "تحويلات TikTok Ads",
    value: "10,957",
    unit: "تحويل",
    source: "TikTok Ads Manager — إجمالي صرف 53,174 EGP على 2.9M ظهور",
    period: "2025-12-10 → 2026-02-24",
    platform: "TikTok Ads",
  },
];
...
export const whyWorkWithMe = [
  {
    ...
    desc: "كل قرار ميزانية أو استهداف مبني على أرقام حقيقية من مدير الإعلانات ومن لوحة المبيعات معًا، مش على إحساس.",
  },
  {
    title: "Creative Testing",
    desc: "أختبر أكثر من Hook وزاوية إعلانية قبل ضخ الميزانية، وأوقف أي إعلان لا يثبت نفسه خلال أول أيام قليلة.",
  },
  {
    title: "Performance Optimization",
    desc: "متابعة يومية لـ CTR وCPC وCPM وتكلفة النتيجة، مع تعديل فوري للحملات الضعيفة قبل أن تستنزف الميزانية.",
  },
  {
    title: "Scalable Growth",
    desc: "أوسّع الحملات الرابحة تدريجيًا مع مراقبة استقرار تكلفة النتيجة، بدل زيادة الميزانية دفعة واحدة وتفجير الأداء.",
  },
];
...
export const caseStudies = [
  {
    ...
    title: "متجر تخسيس / مكملات — نمو المبيعات عبر Meta Ads",
    ...
    metrics: {
      ...
      revenue: "785.57K EGP",
      netProfit: "685.49K EGP",
      visits: "36.99K",
      orders: "3.39K",
      conversionRate: "9.17%",
      avgOrderValue: "231 EGP",
      missedRate: "13.81%",
  ...
  },
  {
    ...
    metrics: {
      ...
      netProfit: "[ADD VERIFIED DATA]",
      impressions: "2,902,589",
      clicks: "36,394",
      ctr: "1.25%",
      cpc: "1.46 EGP",
      cpm: "18.32 EGP",
...
export const creatives = [
  {
    ...
    platform: "Meta Ads",
    type: "Static / UGC",
    hook: "[ADD YOUR REAL HOOK]",
    angle: "[ADD YOUR REAL ANGLE]",
    objective: "Purchase / Conversion",
    result: "[ADD VERIFIED RESULT]",
    image: null,
  },
  {
    title: "TikTok Ads — Creative Strategy Slot",
    platform: "TikTok Ads",
    type: "Video / UGC",
    hook: "[ADD YOUR REAL HOOK]",
    angle: "[ADD YOUR REAL ANGLE]",
